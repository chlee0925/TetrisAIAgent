...
public class NoVisualPlayerSkeleton {
    public static void main(String[] args) {
        ...
        while(!s.hasLost() && s.getTurnNumber() < 5000) s.makeMove(p.pickMoveImpl(s.getField(), s.legalMoves(), s.getTop(), s.getpOrients(), s.getpWidth(), s.getpHeight(), s.getpBottom(), s.getpTop(), s.getNextPiece()));
